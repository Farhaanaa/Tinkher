...
export default function AddMedication() {
  ...
  const handleSuggestionClick = (medication: any) => {
    setForm({
      ...form,
        ...
        <div className={components.contentContainer}>
          <div className="flex items-center gap-4 py-5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-0.5">Enter your medication details</p>
            </div>
          </div>
        </div>
      </header>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setForm({...form, pillsPerDose: parseInt(e.target.value)})}
                    className={components.input}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setForm({...form, totalPills: parseInt(e.target.value)})}
                    className={components.input}
                  />
                </div>
              </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <p>
                        With {form.totalPills} pills taking {form.pillsPerDose} per dose,
                        you have approximately{' '}
                        <span className="font-semibold">
                          {Math.floor(form.totalPills / form.pillsPerDose)} doses
                        </span>{' '}
                        remaining.
                      </p>
                    </div>
